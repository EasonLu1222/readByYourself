...
class ImageList(QWidget):
    def __init__ (self, img_info):
        ...
        self.myQListWidget.setSelectionMode(QAbstractItemView.ExtendedSelection)
    ...
    def setCurrentRow(self, row):
        self.myQListWidget.setCurrentRow(row)
        #  self.myQListWidget.item(row).setSelected(True)
