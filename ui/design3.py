...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBoxFx2 = QtWidgets.QCheckBox(self.widget)
        self.checkBoxFx2.setObjectName("checkBoxFx2")
        self.horizontalLayout.addWidget(self.checkBoxFx2)
        self.checkBoxFx1 = QtWidgets.QCheckBox(self.widget)
        ...
        self.langSelectMenu = QtWidgets.QComboBox(self.widget)
        ...
        self.checkBoxEngMode = QtWidgets.QCheckBox(self.widget)
        ...
        self.pushDetect = QtWidgets.QPushButton(self.widget)
        ...
        self.pushButton.setStyleSheet("background-color:#F0F0F0;border-radius: 15px;")
